...
Ext.define('MyDesktop.Settings', {
    ...
    child: function (img) {
        ...
        return { img: img,
                 text: this.getTextOfWallpaper(img),
                 iconCls: '',
                 leaf: true };
    },
    createTree: function () {
            ...
            store: new Ext.data.TreeStore({
                ...
                root: {
                    ...
                    children: [
                        ...
                        this.child('Dark-Sencha.jpg'),
                        this.child('Wood-Sencha.jpg'),
                        this.child('blue.jpg'),
                        this.child('desk.jpg'),
                        this.child('desktop.jpg'),
                        this.child('desktop2.jpg'),
                        this.child('sky.jpg')
                    ]
                }
            })
    ...
    onSelect: function (tree, record) {
        ...
        if (record.data.img) {
            me.selected = MyUtil.Path.getPathWallpaper(record.data.img);
        } else {
    ...
    setInitialSelection: function () {
        ...
        if (s) {
            var path = MyUtil.Path.getPathWallpaper(s);// '/Wallpaper/' + this.getTextOfWallpaper(s);
